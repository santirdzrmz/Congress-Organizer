...
public class Day3Controllers implements Initializable {
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		List<Day> dataList = readDataFromCSV("Day3.csv");
	...
	public void doneButtonPressed(ActionEvent event) {
		try {
            FileWriter writer = new FileWriter("Day3.csv");
	...
	private List<Day> readDataFromCSV(String csvFile) {
		...
		try {
			reader = new BufferedReader(new FileReader("Day1.csv"));
			reader.readLine();
